...
for i in $(seq 1 1 3)
do
    echo "itertion: spmm original sparse-sparse marlin density compare *****">>spgemm-marlin-density-4-27th.stdout
    echo "********************************">>spgemm-marlin-density-4-27th.stdout
    for d in ${density[@]}
    do
       nohup $SUBMIT $PARAM --name spmm-30k30k30k-$d-858 $JAR 30000 30000 30000 $d 5 8 5 8 2>>stderr 1>>spgemm-marlin-density-4-27th.stdout
       sleep 20
       nohup $SUBMIT $PARAM --name spmm-30k30k30k-$d-949 $JAR 30000 30000 30000 $d 5 9 4 9 2>>stderr 1>>spgemm-marlin-density-4-27th.stdout
       sleep 20
    done
done
...
for i in $(seq 1 1 2)
do
    echo "itertion: spmm to dense-dense marlin density compare *****">>spgemm-marlin-density-4-27th.stdout
    echo "********************************">>spgemm-marlin-density-4-27th.stdout
    for d in ${density[@]}
    do
       nohup $SUBMIT $PARAM --name gemm-30k30k30k-$d-858 $JAR 30000 30000 30000 $d 6 8 5 8 2>>stderr 1>>spgemm-marlin-density-4-27th.stdout
       sleep 20
       nohup $SUBMIT $PARAM --name gemm-30k30k30k-$d-949 $JAR 30000 30000 30000 $d 6 9 4 9 2>>stderr 1>>spgemm-marlin-density-4-27th.stdout
       sleep 20
    done
done
